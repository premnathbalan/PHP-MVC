<?php
App::uses('PhdStudentMark', 'Model');

/**
 * PhdStudentMark Test Case
 */
class PhdStudentMarkTest extends CakeTestCase {
 ...
 */
	public function setUp() {
		parent::setUp();
		$this->PhdStudentMark = ClassRegistry::init('PhdStudentMark');
	}
