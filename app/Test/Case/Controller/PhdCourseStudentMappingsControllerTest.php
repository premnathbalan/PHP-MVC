<?php
App::uses('PhdCourseStudentMappingsController', 'Controller');

/**
 * PhdCourseStudentMappingsController Test Case
 */
class PhdCourseStudentMappingsControllerTest extends ControllerTestCase {
