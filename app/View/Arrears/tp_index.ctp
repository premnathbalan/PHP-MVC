...
<div class="searchFrm bgFrame1">	
	...
	<div class="col-lg-4" style="text-align:center;">		
		<?php echo $this->Form->button('<i class="ace-icon fa fa-check bigger-110"></i>'.__('Search'),array('type'=>'button','name'=>'submit', 'id'=>'arrear_practical','value'=>'submit','class'=>'btn',"onclick"=>"TheoryPracticalAttendanceSearch();"));?>
...
?>
<script>leftMenuSelection('Arrears/tpIndex');</script>
