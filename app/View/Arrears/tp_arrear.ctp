	...
	<div class="searchFrm bgFrame1">
		<div class="col-sm-12">
			...
			<div class="col-lg-6" style='float:right;'>			
				<?php echo $this->Form->button('<i class="ace-icon fa fa-check bigger-110"></i>'.__('&nbsp;Get&nbsp;&nbsp;'),array('type'=>'button','name'=>'button','value'=>'get','class'=>'btn js-arrear-theory-practical')); ?>
...
<script>leftMenuSelection('Arrears/arrear');</script>
