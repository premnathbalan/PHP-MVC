				...
				<tr class=" gradeX">
					...
					<td>
						<?php $cae_marks='';
							...
							echo $this->Form->input('cae_old_marks', array('type'=> 'hidden','id'=>'CaeOldMark'.$i, 'value'=>$cae_marks,'style'=>'position:relative;margin-top:-14px;width:50px;border-color:#000;color:#000;padding-left:10px;', 'label'=>false, 'name' => 'data[Practical][cae_old_marks]['.$student_id.']'));
