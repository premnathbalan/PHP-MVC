...
<?php echo $this->Form->create('Revaluation'); ?>
	<fieldset>
		<legend><?php echo __('Edit Revaluation'); ?></legend>
	<?php
...
<div class="actions">
	...
	<ul>
		...
		<li><?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $this->Form->value('Revaluation.id')), array('confirm' => __('Are you sure you want to delete # %s?', $this->Form->value('Revaluation.id')))); ?></li>
