<div>
	...
	<?php echo $this->Form->button('<i class="ace-icon fa fa-undo bigger-110"></i>'.__('Reset'),array('type'=>'button','name'=>'Reset','value'=>'Reset','class'=>'btn',"onclick"=>"return resetDN('".$DNId."');"));?>
...
<?php echo $this->Html->link("<span class='navbar-brand'><small>EDIT <i class='ace-icon fa fa-angle-double-right'></i></small></span>", array("controller"=>"DummyNumberAllocations",'action' => 'edit',$DNId,''),array('data-placement'=>'left','escape' => false)); ?>
</span>
</div>