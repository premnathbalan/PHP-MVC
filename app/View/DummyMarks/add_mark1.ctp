...
<span><?php echo $this->Html->link("<span class='navbar-brand'><small>Add ( ENTRY $level )<i class='ace-icon fa fa-angle-double-right'></i></small></span>", array("controller"=>"DummyMarks",'action' => 'addMark'.$level,$DNId),array('data-placement'=>'left','escape' => false)); ?></span>
