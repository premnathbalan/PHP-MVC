...
<div class="searchFrm bgFrame1" style="margin-top:5px;">
	...
	<div class="searchFrm col-sm-12">
		...
		<div class="col-lg-3">	
			<?php echo $this->Form->button('<i class="ace-icon fa fa-check bigger-110"></i>'.__('Submit'),array('type'=>'button','id'=>'js-ese-display', 'name'=>'submit','value'=>'submit','class'=>'btn js-ese-display', 'onclick' => 'getEseDisplay(this.id);'));?>
		</div>
...
<?php echo $this->Html->link("<span class='navbar-brand'><small> E.S.E <i class='ace-icon fa fa-angle-double-right'></i></small></span>", array("controller"=>"ContinuousAssessmentExams",'action' => 'theory'),array('data-placement'=>'left','escape' => false)); ?>
</span>