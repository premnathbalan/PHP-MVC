...
<table border="1" style="margin:5px;" class="display tblOddEven">
	...
	<tr>
		...
		<td align="center"><?php echo $this->Html->link($result['oneArrear'], array("controller"=>"EndSemesterExams",'action' => 'listStudents', $batch_id, $program_id, "1", $month_year_id),array('target'=>'_blank','escape' => false, 'title'=>'View')); ?></td>
		<td align="center"><?php echo $this->Html->link($result['twoArrear'], array("controller"=>"EndSemesterExams",'action' => 'listStudents', $batch_id, $program_id, "2", $month_year_id),array('target'=>'_blank','escape' => false, 'title'=>'View')); ?></td>
		<td align="center"><?php echo $this->Html->link($result['threeArrear'], array("controller"=>"EndSemesterExams",'action' => 'listStudents', $batch_id, $program_id, "3", $month_year_id),array('target'=>'_blank','escape' => false, 'title'=>'View')); ?></td>
		<td align="center"><?php echo $this->Html->link($result['moreThanThreeArrear'], array("controller"=>"EndSemesterExams",'action' => 'listStudents', $batch_id, $program_id, "4", $month_year_id),array('target'=>'_blank','escape' => false, 'title'=>'View')); ?></td>
