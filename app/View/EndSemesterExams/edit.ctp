...
<?php echo $this->Form->create('EndSemesterExam'); ?>
	<fieldset>
		<legend><?php echo __('Edit End Semester Exam'); ?></legend>
	<?php
...
<div class="actions">
	...
	<ul>
		...
		<li><?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $this->Form->value('EndSemesterExam.id')), array('confirm' => __('Are you sure you want to delete # %s?', $this->Form->value('EndSemesterExam.id')))); ?></li>
