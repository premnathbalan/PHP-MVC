...
<div class="searchFrm bgFrame1">
		<div class="col-sm-12">
			...
			<div class="col-lg-4">			
				<?php echo $this->Form->button('<i class="ace-icon fa fa-check bigger-110"></i>'.__('&nbsp;Get&nbsp;&nbsp;'),array('type'=>'button','name'=>'button','value'=>'get','class'=>'btn js-revaluation-report-batchwise')); ?>
...
<span class='navbar-brand'><small>REVALUATIONS <i class='ace-icon fa fa-angle-double-right'></i></small></span>
<?php echo $this->Html->link("<span class='navbar-brand'><small>BatchWise <i class='ace-icon fa fa-angle-double-right'></i></small></span>", array("controller"=>"RevaluationExams",'action' => 'batchwise'),array('data-placement'=>'left','escape' => false)); ?>
</span>