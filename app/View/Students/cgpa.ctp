...
<div class="searchFrm bgFrame1">	
	<div class="col-lg-12">
		...
		<div class="col-lg-4">
			<?php echo $this->Form->input('monthyears', array('type' => 'select', 'empty' => __("----- Select MonthYear-----"), 'label' => "MonthYear<span class='ash'>*</span>", 'options'=>$monthyears)); ?>
		</div>
	</div>
	...
	<div class="col-lg-4" style="text-align:center;">		
		<?php echo $this->Form->button('<i class="ace-icon fa fa-check bigger-110"></i>'.__('Search'),array('type'=>'submit','name'=>'submit','value'=>'submit','class'=>'btn',"onclick"=>"cgpaList();"));?>
