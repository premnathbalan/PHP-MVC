...
<?php echo $this->Html->link("<span class='navbar-brand'><small>Consolidate Marksheet <i class='ace-icon fa fa-angle-double-right'></i></small></span>", array("controller"=>"Students",'action' => 'cMSearch'),array('data-placement'=>'left','escape' => false)); ?>
</span>