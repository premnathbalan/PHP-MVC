	...
	<table cellpadding='0' cellspacing='0' border='1' class='display' id='example' style='margin-top:10px;'>
		<thead>
			<tr>
				...
				<th style='padding:0px;text-align:center;'>Percent</th>
		...
		<tbody>
		<?php
		foreach ($finalArray as $student_id => $result) {
			echo "<tr>";
			echo "<td align='center'>".$result['reg_num']."</td>";
			echo "<td align='center'>".$result['name']."</td>";
			echo "<td align='center'>".$result['semTotal']['semester1Total']."</td>";
			echo "<td align='center'>".$result['semTotal']['semester2Total']."</td>";
			echo "<td align='center'>".$result['semTotal']['semester3Total']."</td>";
			echo "<td align='center'>".$result['semTotal']['semester4Total']."</td>";
			echo "<td align='center'>".$result['semTotal']['semester5Total']."</td>";
			echo "<td align='center'>".$result['semTotal']['semester6Total']."</td>";
			echo "<td align='center'>".$result['semTotal']['semester7Total']."</td>";
			echo "<td align='center'>".$result['semTotal']['semester8Total']."</td>";
			echo "<td align='center'>".$result['semTotal']['semester9Total']."</td>";
			echo "<td align='center'>".$result['semTotal']['semester10Total']."</td>";
			echo "<td align='center'>".$result['total']."</td>";
			echo "<td align='center'>".$result['totalCoursePassMark']."</td>";
			echo "<td align='center'>".$result['percentage']."</td>";
			...
			echo "<td align='center'>".$result['result']."</td>";
			echo "<td align='center'>".$result['class']."</td>";
			echo "</tr>";
		}
		?>		
	</tbody>
	<tfoot>
		<tr>
			...
			<th><input type="text" name="Grand</br>Total" value="Grand Total" class="search_init" /></th>
			<th><input type="text" name="Total</br>Scored" value="Total Scored" class="search_init" /></th>
			<th><input type="text" name="Percent" value="Percent" class="search_init" /></th>
			...
			<th><input type="text" name="Class</br>Secured" value="Class Secured" class="search_init" /></th>
		</tr>
	</tfoot>
