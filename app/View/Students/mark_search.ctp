...
<div class="searchFrm bgFrame1">	
	...
	<div class="col-lg-4" style="text-align:center;">		
		<?php echo $this->Form->button('<i class="ace-icon fa fa-check bigger-110"></i>'.__('Search'),array('type'=>'submit','name'=>'submit','value'=>'submit','class'=>'btn',"onclick"=>"markList();"));?>
...
<?php echo $this->Html->link("<span class='navbar-brand'><small>MARK Report <i class='ace-icon fa fa-angle-double-right'></i></small></span>", array("controller"=>"Students",'action' => 'mark_search'),array('data-placement'=>'left','escape' => false)); ?>
</span>