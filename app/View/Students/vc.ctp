...
<?php echo $this->Html->css('certificate');?>
  <table class="page"  style="border:1px; border-color:#000;">		
  		<tr>
  			<td>
  				<table border="0" cellspacing="0" cellspading="0" style="width:100%;margin-top:110px;"> 
  					<tr>
  						<td colspan="5" class="tc1" align="center">VERIFICATION CERTIFICATE</td>
  					</tr>
  					<tr>
					<td colspan="4"></td>
  					...
  					<tr>
						...
						?></td>
  						<td align="center">Date : <?php echo date( "d-M-Y", strtotime($issue_date) ); ?></td>
  						<td rowspan="3" height="80" valign="top" width="20%">
  						<?php 
  					...
  					<tr>
						...
						<td class='tc2'>Name of the Student in full </td>
  						<td class='tc3'>:</td>
  						<td class='tc4'><?php echo $result['Student']['name'];?></td>
  					</tr>
					<tr>
  						<td class='tc5'>2.</td>
						<td class='tc2'>Register Number </td>
  						<td class='tc3'>:</td>
  						<td class='tc4'><?php echo $result['Student']['registration_number'];?></td>
  					</tr>
					<tr>
  						<td class='tc5'>3.</td>
