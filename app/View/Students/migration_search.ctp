...
<?php echo $this->Html->link("<span class='navbar-brand'><small>MIGRATION CERTIFICATE <i class='ace-icon fa fa-angle-double-right'></i></small></span>", array("controller"=>"Students",'action' => 'migrationSearch'),array('data-placement'=>'left','escape' => false)); ?>
</span>