...
<script>leftMenuSelection('Students/publishWebsiteMarkAfterRevaluation');</script>
...
<?php echo $this->Html->link("<span class='navbar-brand'><small>MARK DATA COE <i class='ace-icon fa fa-angle-double-right'></i></small></span>", array("controller"=>"Students",'action' => 'publishWebsiteMarkAfterRevaluation'),array('data-placement'=>'left','escape' => false)); ?>
</span>