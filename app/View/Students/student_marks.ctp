...
<table border="1" style="margin:5px;" class="display tblOddEven">
	<tr><th>S.No.</th><th>Course Type</th><th>Course Name</th><th>MonthYear</th><th>Marks</th><th>Status</th></tr>
...
<?php echo $this->Html->link("<span class='navbar-brand'><small> VIEW MARKS ( $studentId ) <i class='ace-icon fa fa-angle-double-right'></i></small></span>", array("controller"=>"Students",'action' => 'student_marks',$studentId),array('data-placement'=>'left','escape' => false)); ?>
</span>