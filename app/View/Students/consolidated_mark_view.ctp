...
<div class="searchFrm bgFrame1">	
	...
	<div class="col-lg-12">
		<div class="col-lg-4">		
			<?php echo $this->Form->input('month_year_id', array('type' => 'select', 'options'=>$monthyears, 'empty' => __("----- Select Month Year-----"), 'label' => "MonthYear", 'class' => 'js-month-year')); ?>
		</div>
		<div class="col-lg-4">
			<?php echo $this->Form->input('register_no', array('id'=>'register_no','type' => 'text', 'label' => "Register No.", 'style' => 'margin-top:10px;')); ?>
		</div>
		
		<div class="col-lg-4" style="text-align:center;">		
			<?php echo $this->Form->button('<i class="ace-icon fa fa-check bigger-110"></i>'.__('Search'),array('type'=>'submit','name'=>'submit','value'=>'submit','class'=>'btn',"onclick"=>"consolidateMarkView();"));?>
