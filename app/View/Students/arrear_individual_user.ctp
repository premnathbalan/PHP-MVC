...
$i=1;
if (isset($results)) { //pr($results); die;
						...
						$no_of_caes = count($csmDetails['Cae']);
							echo "<tr id=cm_id_$cm_id class='cm_id'>";
								...
								if (isset($csmArray['CourseMapping'][$model]) && count($csmArray['CourseMapping'][$model])>0) {
									...
									if($model == "EndSemesterExam") $fieldEse = "marks";
									else $fieldEse = "revaluation_marks";
									$ese_marks = $csmArray['CourseMapping'][$model][0][$fieldEse];
