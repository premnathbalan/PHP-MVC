...
<?php echo $this->Form->create('ProjectReview'); ?>
	<fieldset>
		<legend><?php echo __('Edit Project Review'); ?></legend>
	<?php
...
<div class="actions">
	...
	<ul>
		...
		<li><?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $this->Form->value('ProjectReview.id')), array('confirm' => __('Are you sure you want to delete # %s?', $this->Form->value('ProjectReview.id')))); ?></li>
