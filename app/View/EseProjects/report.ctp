...
<div class="searchFrm bgFrame1">
	<?php echo $this->Form->create('ProjectReport');?>
		...
		<div class="col-sm-9">
			...
			<div class="col-lg-6">		
				<?php echo $this->Form->input('option_id', array('type' => 'select', 'options'=>array("All"=>"All","Pass"=>"Pass","Fail"=>"Fail"), 'label' => "<span class='ash'>*</span> Category", 'class' => 'js-project-category')); ?></div>
			</div>
		</div>
		
		<div class="col-lg-3">			
		<?php echo $this->Form->button('<i class="ace-icon fa fa-check bigger-110"></i>'.__('&nbsp;Get&nbsp;&nbsp;'),array('type'=>'button','name'=>'button','value'=>'Get','class'=>'btn js-project-report')); ?>
		</div>
		<div class="col-lg-3">
...
<?php echo $this->Html->link("<span class='navbar-brand'><small> Project Report <i class='ace-icon fa fa-angle-double-right'></i></small></span>", array("controller"=>"EseProjects",'action' => 'report'),array('data-placement'=>'left','escape' => false)); ?>
</span>