...
<?php echo $this->Html->link("<span class='navbar-brand'><small> Calculate Project <i class='ace-icon fa fa-angle-double-right'></i></small></span>", array("controller"=>"EseProjects",'action' => 'calculate'),array('data-placement'=>'left','escape' => false)); ?>
</span>