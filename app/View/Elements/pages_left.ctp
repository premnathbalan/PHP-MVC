  ...
  <ul class="nav nav-list">    
    ...
    <li class=""> <a href="#" class="dropdown-toggle"> <i class="menu-icon fa fa-graduation-cap"></i> <span class="menu-text"> PhD Students </span> <b class="arrow fa fa-angle-down"></b> </a> <b class="arrow"></b>
      <ul class="submenu">
        ...
        <li class=""><?php echo $this->Html->link("Courses"." <i class='menu-icon fa fa-caret-right'></i><b class='arrow'></b>", array("controller"=>"PhdCourses",'action' => 'index'),array('data-placement'=>'left','escape' => false));?></li>
        <li class=""><?php echo $this->Html->link("Add Phd Student"." <i class='menu-icon fa fa-caret-right'></i><b class='arrow'></b>", array("controller"=>"PhdStudents",'action' => 'add'),array('data-placement'=>'left','escape' => false));?></li>
        <li class=""><?php echo $this->Html->link("Search Student"." <i class='menu-icon fa fa-caret-right'></i><b class='arrow'></b>", array("controller"=>"PhdStudents",'action' => 'searchIndex'),array('data-placement'=>'left','escape' => false));?></li>
        ...
        <!--<li class=""><?php echo $this->Html->link("Course Completion Certificate"." <i class='menu-icon fa fa-caret-right'></i><b class='arrow'></b>", array("controller"=>"PhdStudents",'action' => 'ccSearch'),array('data-placement'=>'left','escape' => false));?></li>-->
      </ul>
    </li>
    <?php //}
    ?>
    ...
    <li class=""> <a href="#"  class="dropdown-toggle"> <i class="menu-icon fa fa-list-alt"></i> <span class="menu-text"> Arrear</span> <b class="arrow fa fa-angle-down"></b></a> <b class="arrow"></b> 
		<ul class="submenu">
			...
			<li class=""> <a href="#"  class="dropdown-toggle"> <i class="menu-icon fa fa-flask"></i>Theory and Practical</span> <b class="arrow"></b></a> <b class="arrow"></b> 
				<ul class="submenu">
				<li class=""><?php echo $this->Html->link("<i class='menu-icon fa fa-caret-right'></i>"."Theory Practical Arrear<br/>Theory Practical Arrear Attendace Sheet<br/>Theory Practical Arrear Cover Page", array("controller"=>"Arrears",'action' => 'tpIndex'),array('data-placement'=>'left','escape' => false)); ?>
				<li class=""><?php echo $this->Html->link("<i class='menu-icon fa fa-caret-right'></i>"."Theory Practicals Arrear Mark entry", array("controller"=>"Arrears",'action' => 'tpArrear'),array('data-placement'=>'left','escape' => false)); ?>
				</ul>
			</li>	
			...
			<li class=""> <a href="#"  class="dropdown-toggle"> <i class="menu-icon fa fa-list-alt"></i>Professional Training</span> <b class="arrow"></b></a> <b class="arrow"></b> 
				<ul class="submenu">
				<li class=""><?php echo $this->Html->link("<i class='menu-icon fa fa-caret-right'></i>"."Professional Training Arrear Mark entry", array("controller"=>"PTArrears",'action' => 'index'),array('data-placement'=>'left','escape' => false)); ?>
				</ul>
			</li>
		</ul>
	</li>	
    ...
    <li class=""> <a href="#"  class="dropdown-toggle"> <i class="menu-icon fa fa-list-alt"></i> <span class="menu-text"> Examination </span> <b class="arrow fa fa-angle-down"></b></a> <b class="arrow"></b> 
		...
		<li class=""><?php echo $this->Html->link("<i class='menu-icon fa fa-caret-right'></i>"."Hall Ticket", array("controller"=>"Timetables",'action' => 'hallTicketSearch'),array('data-placement'=>'left','escape' => false)); ?>
		...
		<li class=""><?php echo $this->Html->link("<i class='menu-icon fa fa-caret-right'></i>"."TimeTable Automation", array("controller"=>"Timetables",'action' => 'timetable'),array('data-placement'=>'left','escape' => false)); ?>
	...
	<li class=""> <a href="#" class="dropdown-toggle"> <i class="menu-icon fa fa-list"></i> <span class="menu-text"> Results </span> <b class="arrow fa fa-angle-down"></b></a> <b class="arrow"></b>
		<ul class="submenu">		
			...
			<li class=""> <?php echo $this->Html->link("<i class='menu-icon fa fa-caret-right'></i>"."Programwise Publish Results", array("controller"=>"EndSemesterExams",'action' => 'pgmwisePublishSearch'),array('data-placement'=>'left','escape' => false)); ?></li>
	...
	<li class=""> <a href="" class="dropdown-toggle"> <i class="menu-icon fa fa-laptop"></i> <span class="menu-text"> Reports </span> <b class="arrow fa fa-angle-down"></b></a> <b class="arrow"></b>
		<ul class="submenu">
		<!--<li class=""> <?php echo $this->Html->link("<i class='menu-icon fa fa-caret-right'></i>"."Result Analysis - BR", array("controller"=>"EndSemesterExams",'action' => 'report','BR'),array('data-placement'=>'left','escape' => false)); ?></li>-->
		<li class=""> <?php echo $this->Html->link("<i class='menu-icon fa fa-caret-right'></i>"."Students Data", array("controller"=>"Students",'action' => 'dataSearch'),array('data-placement'=>'left','escape' => false)); ?></li>
		<li class=""> <?php echo $this->Html->link("<i class='menu-icon fa fa-caret-right'></i>"."Courses Report", array("controller"=>"CourseMappings",'action' => 'courseSearch'),array('data-placement'=>'left','escape' => false)); ?></li>
		...
		<li class=""> <?php echo $this->Html->link("<i class='menu-icon fa fa-caret-right'></i>"."Arrear Count Report", array("controller"=>"Timetables",'action' => 'arrearCount'),array('data-placement'=>'left','escape' => false)); ?></li>
		<li class=""> <?php echo $this->Html->link("<i class='menu-icon fa fa-caret-right'></i>"."Timetable DayWise Report ", array("controller"=>"Timetables",'action' => 'daywiseStrengthReport'),array('data-placement'=>'left','escape' => false)); ?></li>
		...
		<li class=""> <?php echo $this->Html->link("<i class='menu-icon fa fa-caret-right'></i>"."Mark Report", array("controller"=>"Students",'action' => 'mark_search'),array('data-placement'=>'left','escape' => false)); ?></li>
		<li class=""> <?php echo $this->Html->link("<i class='menu-icon fa fa-caret-right'></i>"."Student Mark", array("controller"=>"Students",'action' => 'mSearch'),array('data-placement'=>'left','escape' => false)); ?></li>
		<li class=""> <?php echo $this->Html->link("<i class='menu-icon fa fa-caret-right'></i>"."Student Mark Bulk", array("controller"=>"Students",'action' => 'stuMarkSearch'),array('data-placement'=>'left','escape' => false)); ?></li>
		...
		<li class=""> <?php echo $this->Html->link("<i class='menu-icon fa fa-caret-right'></i>"."Student Mark Report", array("controller"=>"Students",'action' => 'mSearch'),array('data-placement'=>'left','escape' => false)); ?></li>
		...
		<li class=""> <?php echo $this->Html->link("<i class='menu-icon fa fa-caret-right'></i>"."Revaluation Consolidated Report", array("controller"=>"Revaluations",'action' => 'mark'),array('data-placement'=>'left','escape' => false)); ?></li>
    ...
    <li class=""> <a href="#" class="dropdown-toggle"> <i class="menu-icon fa fa-certificate"></i> <span class="menu-text"> Certificates </span> <b class="arrow fa fa-angle-down"></b> </a> <b class="arrow"></b>
      <ul class="submenu">
        ...
        <li class=""><?php echo $this->Html->link("Transfer Certificate"." <i class='menu-icon fa fa-caret-right'></i><b class='arrow'></b>", array("controller"=>"Students",'action' => 'tcSearch',3),array('data-placement'=>'left','escape' => false)); ?></li>
		...
		<li class=""><?php echo $this->Html->link("Rank Certificate"." <i class='menu-icon fa fa-caret-right'></i><b class='arrow'></b>", array("controller"=>"Students",'action' => 'rankSearch'),array('data-placement'=>'left','escape' => false)); ?></li>
      </ul>
    </li>
    <?php //}
    ?>
