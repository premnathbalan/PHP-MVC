...
<?php echo $this->Html->link("<span class='navbar-brand'><small> Add Marks <i class='ace-icon fa fa-angle-double-right'></i></small></span>", array("controller"=>"CaeProjects",'action' => 'addMarks',$batchId,$academicId,$programId,$caeId,$caeNumber),array('data-placement'=>'left','escape' => false)); ?>
</span>	