...
<div style="height:40px;">
	<?php 
		if($this->Html->checkPathAccesstopath('CaeProjects/add','',$authUser['id'])){
			echo $this->Html->link('<i class="ace-icon fa fa-plus-square"></i>'. 'Add CAE', array("controller"=>"CaeProjects",'action'=>'add'),array('class' =>" addBtn btn js-cae-add",'escape' => false, 'title'=>'Add'));
		} 
	?>
</div>
