...
<?php echo $this->Form->create('CaePractical'); ?>
	<fieldset>
		<legend><?php echo __('Edit Cae Practical'); ?></legend>
	<?php
...
<div class="actions">
	...
	<ul>
		...
		<li><?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $this->Form->value('CaePractical.id')), array('confirm' => __('Are you sure you want to delete # %s?', $this->Form->value('CaePractical.id')))); ?></li>
