<div class="revaluationExams form">
<?php echo $this->Form->create('RevaluationExam'); ?>
	<fieldset>
		<legend><?php echo __('Add Revaluation Exam'); ?></legend>
	<?php
		...
		echo $this->Form->input('reval_dummy_mod_operator');
		echo $this->Form->input('reval_dummy_mod_marks');
		echo $this->Form->input('reval_moderation_marks');
		echo $this->Form->input('reval_moderation_operator');
