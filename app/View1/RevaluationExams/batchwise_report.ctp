...
<div class="searchFrm bgFrame1" style="margin-top:7px;">
		<div class="col-sm-12">
			<div class="col-lg-12">	
			<?php 
			echo $this->Html->link(' <i class="ace-icon fa fa-undo bigger-110"></i> '.'&nbsp;Print&nbsp;',array("controller"=>"RevaluationExams",'action'=>'getReport', $batch_id, $month_year_id, 1),array('type'=>'submit','name'=>'reset','value'=>'reset','class'=>'btn js-report-batchwise-print','escape' => false));?>		
			</div>
		</div>
	</div>	
</div>
