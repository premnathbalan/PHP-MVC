...
<span><?php echo $this->Html->link("<span class='navbar-brand'><small>Edit ( ENTRY $level ) <i class='ace-icon fa fa-angle-double-right'></i></small></span>", array("controller"=>"RevaluationDummyMarks",'action' => 'editMark'.$level,$dummy_number_id,$level),array('data-placement'=>'left','escape' => false)); ?></span>
