...
class AppHelper extends Helper {
	...
	public function getMonthYears($id) {
		...
		$resMonth = array();
		if($res){			
			$resMonth[0] = $res['Month']['month_name']." ".$monthYear;
			$resMonth[1] = $res['Month']['tamil_month_name']." ".$monthYear;		
		}
		return $resMonth;
	}
	...
	public function getTheoryCaeAndEse($courseTypeId, $cm_id, $student_id, $actualMYId, $revaluation_status) {
		App::import("Model", "Student");
		$model = new Student();
		$results=array();
		$res = $model->find('all', array(
				...
				'contain'=>array(
						...
						'EndSemesterExam' => array(
								...
								'conditions' => array('EndSemesterExam.course_mapping_id'=>$cm_id,
		...
		else $results['ese'] = $res[0]['EndSemesterExam'][0]['marks'];
		$results['total'] = $results['cae']+$results['ese'];
		return $results;
	}
	
	public function getPracticalCaeAndEse($courseTypeId, $cm_id, $student_id, $actualMYId, $revaluation_status) {
		App::import("Model", "CourseMapping");
		$model = new CourseMapping();
		$markArray = array();
	...
	public function getProjectCaeAndEse($courseTypeId, $cm_id, $student_id, $actualMYId, $revaluation_status) {
		App::import("Model", "CourseMapping");
		$model = new CourseMapping();
		$markArray = array();
		$results = $model->find('all', array(
				...
				'contain'=>array(
						...
						'EseProject' => array(
								...
								'ProjectViva' => array(
										...
										'conditions' => array('ProjectViva.month_year_id' => $actualMYId, 'ProjectViva.student_id'=>$student_id
										),
