...
echo $this->Form->input('month_year_id', array('label' => false, 'type' => 'hidden', 'default' => $month_year_id));
?>
			...
			<tbody>
				...
				<tr class=" gradeX">
					...
					<td><?php 
								...
								echo $this->Form->input('marks', array('type'=>'text', 'label' => false, 'name'=>'data[EsePractical][marks]['.$student_id.']'));
						?></td>
				</tr>
				  <?php
				  $j++;
