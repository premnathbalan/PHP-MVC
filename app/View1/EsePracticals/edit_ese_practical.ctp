			...
			<tbody>
				...
				<tr class=" gradeX">
					...
					<td><?php 
								...
								echo $this->Form->input('id', array('type'=>'hidden', 'label' => false, 'default' => $temp['id'], 'name'=>'data[EsePractical][id]['.$student_id.']'));
								echo $this->Form->input('marks', array('type'=>'text', 'label' => false, 'default' => $temp['marks'], 'name'=>'data[EsePractical][marks]['.$student_id.']'));
								//echo $temp['marks'];
						?></td>
				</tr>
				  <?php
...
<span class='navbar-brand'><small>Edit <i class='ace-icon fa fa-angle-double-right'></i></small></span>
