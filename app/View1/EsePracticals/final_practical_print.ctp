...
?>
	<table class="attendanceHeadTblP" border="1" cellpadding="0" cellspacing="0">
		<tr><td colspan="4" align="center"><b>FINAL PRACTICAL - OUT OF 100 MARKS</b></td></tr>
		<tr>
...
<thead>
	...
	<tr>
		...
		<th>Reg.&nbsp;No.</th>
		<th>Student&nbsp;Name</th>
		<?php foreach ($courseMappingArray as $cmId => $courseCodeArray) {
		?>
		<th><?php echo $courseCodeArray['course_code']." CAE - (".$result['practical'][$cmId]['courseDetails']['max_cae_mark']." Marks)"; ?></th>
		<th><?php echo $courseCodeArray['course_code']." ESE - (".$result['practical'][$cmId]['courseDetails']['max_ese_mark']." Marks)"; ?></th>
		<th><?php echo $courseCodeArray['course_code']." Total - (".$result['practical'][$cmId]['courseDetails']['course_max_marks']." Marks)"; ?></th>
		<th><?php echo $courseCodeArray['course_code']." Result"; ?></th>
		<?php }	?>
	</tr>
	<?php }?>
</thead>
...
<thead>	
	...
	<tr>
		...
		<th>Student&nbsp;Name</th>
		<?php foreach ($courseMappingArray as $cmId => $courseCodeArray) {?>
		<th><?php echo $courseCodeArray['course_code']." CAE"; ?></th>
		<th><?php echo $courseCodeArray['course_code']." ESE"; ?></th>
		<th><?php echo $courseCodeArray['course_code']." Total"; ?></th>
		<th><?php echo $courseCodeArray['course_code']." Result"; ?></th>
		<?php }	?>
	</tr>
	<?php }?>
