				...
				<tr class=" gradeX">
					...
					<td>
						<?php $cae_marks='';
							...
							echo $this->Form->input('cae_old_marks', array('type'=> 'hidden','id'=>'CaeOldMark'.$i, 'default'=>$cae_marks,'style'=>'position:relative;margin-top:-14px;width:50px;border-color:#000;color:#000;padding-left:10px;', 'label'=>false, 'name' => 'data[Practical][cae_old_marks]['.$student_id.']'));
							echo $this->Form->input('cae_new_marks', array('type'=> 'text','id'=>'CaeNewMark'.$i, 'default'=>$cae_marks, 'class'=>'dummy','style'=>'position:relative;margin-top:-14px;width:50px;border-color:#000;color:#000;padding-left:10px;', 'label'=>false, 'name' => 'data[Practical][cae_new_marks]['.$student_id.']', 'onblur'=>"ArrearPracCAEEntry($i,this.value,$student_id,$exam_month_year_id);"));
						?>
