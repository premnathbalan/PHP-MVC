...
<script>leftMenuSelection('EseProjects/finalProject');</script>
...
<?php echo $this->Html->link("<span class='navbar-brand'><small> Final Practical Marks <i class='ace-icon fa fa-angle-double-right'></i></small></span>", array("controller"=>"EseProjects",'action' => 'finalProject'),array('data-placement'=>'left','escape' => false)); ?>
</span>