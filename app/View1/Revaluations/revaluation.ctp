...
<div class="caes index">
	<div class="searchFrm bgFrame1 col-sm-12">		
		...
		<div class="col-lg-4">		
			<?php echo $this->Form->input('reg_number', array('type' => 'text', 'label' => "<span class='ash'>*</span> Reg Number",'style'=>'margin-top:10px;')); ?>
		</div>
		<div class="col-lg-4">			
			<?php echo $this->Form->button('<i class="ace-icon fa fa-check bigger-110"></i>'.__('&nbsp;Get&nbsp;&nbsp;'),array('type'=>'button','name'=>'button','value'=>'get','class'=>'btn js-reval')); ?>
