<div class="revaluations index">
	<h2><?php echo __('Revaluations'); ?></h2>
	...
	<tr>
			...
			<th><?php echo $this->Paginator->sort('ese_marks'); ?></th>
	...
	<tr>
		<td><?php echo h($revaluation['Revaluation']['id']); ?>&nbsp;</td>
		<td>
		...
		<td><?php echo h($revaluation['Revaluation']['ese_marks']); ?>&nbsp;</td>
		<td><?php echo h($revaluation['Revaluation']['moderation_marks']); ?>&nbsp;</td>
		<td><?php echo h($revaluation['Revaluation']['moderation_operator']); ?>&nbsp;</td>
		<td><?php echo h($revaluation['Revaluation']['marks']); ?>&nbsp;</td>
		<td><?php echo h($revaluation['Revaluation']['final_marks']); ?>&nbsp;</td>
		<td><?php echo h($revaluation['Revaluation']['created_by']); ?>&nbsp;</td>
		<td><?php echo h($revaluation['Revaluation']['modified_by']); ?>&nbsp;</td>
		<td><?php echo h($revaluation['Revaluation']['created']); ?>&nbsp;</td>
		<td><?php echo h($revaluation['Revaluation']['modified']); ?>&nbsp;</td>
		<td class="actions">
			<?php echo $this->Html->link(__('View'), array('action' => 'view', $revaluation['Revaluation']['id'])); ?>
			<?php echo $this->Html->link(__('Edit'), array('action' => 'edit', $revaluation['Revaluation']['id'])); ?>
			<?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $revaluation['Revaluation']['id']), array('confirm' => __('Are you sure you want to delete # %s?', $revaluation['Revaluation']['id']))); ?>
		</td>
	</tr>
<?php endforeach; ?>
	</tbody>
