...
<?php echo $this->Form->create('Student', array('type' => 'file')); echo $this->data['Student']['picture']; ?>	
		 <div class="col-sm-12"  style="text-align:center;">	                                
			<div calss="bgFrame1 col-sm-2">
				<?php if(isset($this->data['Student']['picture'])){echo $this->Html->image(h("students/".$this->data['Student']['picture']));}?>
				<input type="hidden" name="old_picture" value="<?php if(isset($this->data['Student']['picture'])){echo $this->data['Student']['picture'];}?>">
				<?php if(isset($this->data['Student']['signature'])){echo $this->Html->image(h("signature/".$this->data['Student']['signature']));}?>
			</div>
		</div>
	<div class="bgFrame1">
	    <div class="col-sm-4">	                                
   ...
   <div class="bgFrame1">      
	...
	<div class="bgFrame1">        
        ...
        <div class="col-sm-4">
		<?php echo $this->Form->input('addlfield5'); ?>
		</div>       
		<div class="col-sm-5">
