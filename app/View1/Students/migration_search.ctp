...
<?php echo $this->Html->link("<span class='navbar-brand'><small>SEMESTER MARK SHEET <i class='ace-icon fa fa-angle-double-right'></i></small></span>", array("controller"=>"Students",'action' => 'markSheetSearch'),array('data-placement'=>'left','escape' => false)); ?>
</span>