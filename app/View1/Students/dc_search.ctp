...
<div class="searchFrm bgFrame1">	
	...
	<div class="col-lg-12">
		...
		<div class="col-lg-4">
			<?php echo $this->Form->input("convocation_date", array('label' => "Convocation </br>Date <span class='ash'>*</span>", 'type' => 'text', 'class' => 'fl tal vat w300p', 'error' => false , 'id' => 'select_date'));?>
		</div>				
	</div>
	<div class="col-lg-12">
...
<?php echo $this->Html->link("<span class='navbar-brand'><small>DEGREE CERTIFICATE <i class='ace-icon fa fa-angle-double-right'></i></small></span>", array("controller"=>"Students",'action' => 'dcSearch'),array('data-placement'=>'left','escape' => false)); ?>
</span>