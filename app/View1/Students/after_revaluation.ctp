...
<div class="searchFrm bgFrame1">	
	...
	<div class="col-lg-12">
		...
		<div class="col-lg-4">
		<?php echo $this->Form->input('withheld_type' ,array('label' => "With Held Type",'options' => array('1' => 'Choose Withheld', '2' => 'Withheld Results'),'empty' => __("----- Withheld Type -----"),'onchange'=>'return loadWithheldData(this.value);'));?>
		</div>
		...
		<div class="col-lg-4" style="text-align:center;">		
			<?php echo $this->Form->button('<i class="ace-icon fa fa-check bigger-110"></i>'.__('Search'),array('type'=>'submit','name'=>'submit','value'=>'submit','class'=>'btn',"onclick"=>"beforeRevaluationSearch('after');"));?>
	...
	<div id="afterRevaluationSearch"></div>
