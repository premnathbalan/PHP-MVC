<?php echo $this->Form->create('Withdrawal', array('inputDefaults' => array('div' => false)));?>
<div class="searchFrm bgFrame1" style="width:100%;">
	<div class="col-sm-12">	
		...
		<div class="col-lg-4">		
			<?php echo $this->Form->button('<i class="ace-icon fa fa-check bigger-110"></i>'.__('&nbsp;Get&nbsp;&nbsp;'),array('type'=>'button','name'=>'submit','value'=>'get','class'=>'btn js-withdrawal')); ?>
		</div>
	</div>	
	<!--<div class="col-sm-12">-->
	<!--</div>-->	
