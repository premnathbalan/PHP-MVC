...
<script>leftMenuSelection('Students/topRanking');</script>
...
<?php echo $this->Html->link("<span class='navbar-brand'><small>Top Ranking <i class='ace-icon fa fa-angle-double-right'></i></small></span>", array("controller"=>"Students",'action' => 'topRanking'),array('data-placement'=>'left','escape' => false)); ?>
</span>
