...
<span class='breadcrumb1'>
	...
	<?php echo $this->Html->link("<span class='navbar-brand'><small> Photo Synchronize <i class='ace-icon fa fa-angle-double-right'></i></small></span>", array("controller"=>"Students",'action' => 'photoSynchronize'),array('data-placement'=>'left','escape' => false)); ?>
</span>