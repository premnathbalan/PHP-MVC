...
if(isset($courseMapping['CourseStudentMapping'][0]['Student']['StudentMark'])) { 
	...
	echo "<td align='center'>";
		echo $this->Form->input('cae_marks'.$cm_id, array('type'=>'text', 'name'=>'data[StudentMark][cae_marks]['.$cm_id.']', 'label'=>false, 'value'=>$cae_marks,'style'=>'width:50px;', 'onkeyup'=>"computeBatchTransfer('$cm_id', 'cae', this.value, 50)"));
	...
	echo "</td>";
	echo "<td align='center'>";
		echo $this->Form->input('ese_marks'.$cm_id, array('type'=>'text', 'label'=>false, 'value'=>$ese_marks, 'name'=>'data[StudentMark][ese_marks]['.$cm_id.']','style'=>'width:50px;', 'onkeyup'=>"computeBatchTransfer('$cm_id', 'ese', this.value, 50)"));
