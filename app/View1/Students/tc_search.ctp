...
<div class="searchFrm bgFrame1">	
	...
	<div class="col-lg-12">
		<div class="col-lg-4">
			<?php echo $this->Form->input('type_of_cert', array('type' => 'select', 'empty' => __("----- Type Of Certification -----"), 'label' => "Type Of Certification<span class='ash'>*</span>",'options'=>$typeOfCert,'required'=>'required')); ?>
		</div>
		<div class="col-lg-4">
	...
	<div class="col-lg-12">
		<div class="col-lg-4">
			<?php echo $this->Form->input("convocation_date", array('label' => "TC issue </br>Date <span class='ash'>*</span>", 'type' => 'text', 'class' => 'fl tal vat w300p', 'error' => false , 'id' => 'select_date'));?>
		</div>
		
		<div class="col-lg-4">
			<?php echo $this->Form->input('pgm_status', array('type' => 'select', 'empty' => __("----- Select -----"), 'label' => "Programme Completion Status<span class='ash'>*</span>",'options'=>array('Yes'=>'Yes', 'No'=>'No'),'required'=>'required', 'onchange'=>'dispDate();')); ?>
		</div>
		
		<div class="col-lg-4">
			<div id="pgm_status"></div>
		</div>
	</div>
	<div class="col-lg-12">
		<div class="col-lg-12" style="text-right;">
...
<?php echo $this->Html->link("<span class='navbar-brand'><small>Transfer CERTIFICATE <i class='ace-icon fa fa-angle-double-right'></i></small></span>", array("controller"=>"Students",'action' => 'tcSearch'),array('data-placement'=>'left','escape' => false)); ?>
</span>