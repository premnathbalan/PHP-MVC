	...
	//echo "Withdrawal : ".$withdrawal;
		...
		foreach ($finalArray as $course_mapping_id => $stuValue) {
			...
			if ($stuFinalStatus[$courseMId] == "Pass") {
				...
				SWITCH ($courseTypeId) {
					CASE 1:
						$markArray = $this->Html->getTheoryCaeAndEse($courseTypeId, $courseMId, $studentId, $courseActualMonthYear[$courseMId], $stuValue['revaluation_status']);
						break;
					CASE 2:
					CASE 6:
						$markArray = $this->Html->getPracticalCaeAndEse($courseTypeId, $courseMId, $studentId, $courseActualMonthYear[$courseMId], $stuValue['revaluation_status']);
						break;
					CASE 4:
						$markArray = $this->Html->getProjectCaeAndEse($courseTypeId, $courseMId, $studentId, $courseActualMonthYear[$courseMId], $stuValue['revaluation_status']);
						break;
					CASE 5:
						$markArray = $this->Html->getProfTrainingCae($courseTypeId, $courseMId, $studentId, $courseActualMonthYear[$courseMId], $stuValue['revaluation_status']);
						break;
				}
				...
				<td class="bodertop_0 boderrht_0 boderbot_0" align="right">
					<table class="consolidtbl boder_0 min-hei79 txtind boderrht_0 cMProfTitle" cellspacing="0" cellpadding="0">
						...
						<tr>
							...
							<td class="bodertop_0" width="20%"><strong>';
							$html1.=$lastMY;
							$html1.='</strong></td> 
							<td class="bodertop_0" width="20%"><strong>BATCH</strong></td>
							<td class="bodertop_0" width="20%" colspan="2"><strong>'.$this->Html->getBatch($batchId).'</strong></td>
						</tr>
					</table>
				</td>
			</tr>
...
//$profileImage = $this->Html->image("students/".str_replace("  "," ",str_replace("   "," ",$result['Student']['picture'])));
		...
		<table cellspacing="0" cellpadding="0" border="0" width="100%;" class="cMGrade">
		 ...
		 <tr>
		  ...
		  <tr>
			...
			<td align="left" colspan="2" class="boder_0"><strong>';
			$html1.=$grandTotal;
		...
		<table class="consolidtbl bodertop_0 boder_0" cellspacing="0" cellpadding="0" border="0">
			<tr>
				...
				$html1 .= $this->Html->image("signatures/".$studentSignature, ["alt" => h("student.png"),"style"=>"height:40px;width:60px;"]);	// "style"=>"visibility:hidden;"
				...
				$html1 .='</strong></td>';
				$html1 .='<td width="25%" class="boder_0 " align="right">';
