...
<script>leftMenuSelection('Students/arrearFeesReport');</script>
...
<?php echo $this->Html->link("<span class='navbar-brand'><small>ARREAR FEES REPORT <i class='ace-icon fa fa-angle-double-right'></i></small></span>", array("controller"=>"Students",'action' => 'arrearFeesReport'),array('data-placement'=>'left','escape' => false)); ?>
</span>