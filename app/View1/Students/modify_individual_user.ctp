		...
		SWITCH ($course_type_id) {
					...
					echo "<tr id=cm_id_$cm_id class='cm_id'>";
						...
						foreach ($tmp as $key => $caeArray) { 
						 ...
						 $series = $k+1;
							...
							echo $this->Form->input('cont_ass_marks_new_'.$cm_id.'_'.$k, array('type'=> 'text', 'style'=>'position:relative;margin-top:-14px;width:50px;border-color:#000;color:#000;padding-left:10px;', 'label'=>false, 'default'=>$cont_ass_marks, 'name' => 'data[cae_details][cont_ass_marks_new]['.$cm_id.']['.$k.']', 'onkeyup'=>"computeIndividual('$cm_id', 'cae', this.value, $max_cae_mark, $k)", 'class'=>'caenew_'.$cm_id, 'asessment_type'=>'cae'));
							$k++;
						}
						echo "</td>";
						...
						if (isset($csmArray['CourseMapping'][$model]) && count($csmArray['CourseMapping'][$model])>0) {
							...
							echo $this->Form->input('ese_new_marks_'.$cm_id, array('type'=> 'text', 'style'=>'width:50px;border-color:#000;color:#000;padding-left:10px;', 'label'=>false, 'default'=>$ese_marks, 'name' => 'data[ese_new_marks]['.$cm_id.']', 'onkeyup'=>"computeIndividual('$cm_id', 'ese', this.value, $max_ese_mark, 0)", 'class'=>'esenew_'.$cm_id, 'asessment_type'=>'ese'));
			...
			CASE 2:
				echo "<tr id=cm_id_$cm_id class='cm_id'>";
					...
					echo "<td>";
						...
						echo $this->Form->input('cae_'.$cm_id, array('type'=> 'text', 'style'=>'width:50px;border-color:#000;color:#000;padding-left:10px;', 'label'=>false, 'default'=>$cae, 'name' => 'data[cae]['.$cm_id.']', 'onkeyup'=>"computeIndividual('$cm_id', 'cae', this.value, $max_cae_mark, 0)"));
					...
					echo "<td>";
						...
						echo $this->Form->input('ese_id', array('type'=> 'hidden', 'style'=>'width:50px;border-color:#000;color:#000;padding-left:10px;', 'label'=>false, 'default'=>$ese_id, 'name' => 'data[ese_id]['.$cm_id.']'));
						echo $this->Form->input('ese_old_'.$cm_id, array('type'=> 'hidden', 'style'=>'width:50px;border-color:#000;color:#000;padding-left:10px;', 'label'=>false, 'default'=>$ese, 'name' => 'data[ese_old]['.$cm_id.']'));
						echo $this->Form->input('ese_'.$cm_id, array('type'=> 'text', 'style'=>'width:50px;border-color:#000;color:#000;padding-left:10px;', 'label'=>false, 'default'=>$ese, 'name' => 'data[ese]['.$cm_id.']', 'onkeyup'=>"computeIndividual('$cm_id', 'ese', this.value, $max_ese_mark, 0)"));
			...
			CASE 3:
				...
				$no_of_caes = count($csmDetails['Cae']);
					echo "<tr id=cm_id_$cm_id class='cm_id'>";
						...
						echo $this->Form->input('ese_id', array('type'=> 'hidden', 'style'=>'width:50px;border-color:#000;color:#000;padding-left:10px;', 'label'=>false, 'default'=>$ese_id, 'name' => 'data[ese_id]['.$cm_id.']'));
						echo $this->Form->input('ese_old_'.$cm_id, array('type'=> 'hidden', 'style'=>'width:50px;border-color:#000;color:#000;padding-left:10px;', 'label'=>false, 'default'=>$ese, 'name' => 'data[ese_old]['.$cm_id.']'));
						echo $this->Form->input('ese_'.$cm_id, array('type'=> 'text', 'style'=>'width:50px;border-color:#000;color:#000;padding-left:10px;', 'label'=>false, 'default'=>$ese, 'name' => 'data[ese]['.$cm_id.']', 'onkeyup'=>"computeIndividual('$cm_id', 'ese', this.value, $max_ese_mark)"));
						echo $this->Form->input('ese_mod_marks_'.$cm_id, array('type'=> 'hidden', 'style'=>'width:50px;border-color:#000;color:#000;padding-left:10px;', 'label'=>false, 'default'=>$ese_mod_marks, 'name' => 'data[ese_mod_marks]['.$cm_id.']'));
					echo "</td>";
					...
					echo "<tr id=cm_id_$cm_id class='cm_id'>";
						...
						foreach ($tmp as $key => $caeArray) { 
						 ...
						 $series = $k+1;
							...
							echo "CAE $series : ".$this->Form->input('cont_ass_id'.$k, array('type'=> 'hidden', 'style'=>'position:relative;margin-top:-14px;width:50px;border-color:#000;color:#000;padding-left:10px;', 'label'=>false, 'default'=>$cont_ass_id, 'name' => 'data[cae_details][cont_ass_id]['.$cm_id.']['.$k.']', 'class'=>'cae_'.$cm_id));
							echo $this->Form->input('cont_ass_marks_'.$cm_id.'_'.$k, array('type'=> 'hidden', 'style'=>'position:relative;margin-top:-14px;width:50px;border-color:#000;color:#000;padding-left:10px;', 'label'=>false, 'default'=>$cont_ass_marks, 'name' => 'data[cae_details][cont_ass_marks]['.$cm_id.']['.$k.']', 'class'=>'cae_'.$cm_id));
							echo $this->Form->input('cont_ass_marks_new_'.$cm_id.'_'.$k, array('type'=> 'text', 'style'=>'position:relative;margin-top:-14px;width:50px;border-color:#000;color:#000;padding-left:10px;', 'label'=>false, 'default'=>$cont_ass_marks, 'name' => 'data[cae_details][cont_ass_marks_new]['.$cm_id.']['.$k.']', 'onkeyup'=>"computeIndividual('$cm_id', 'cae', this.value, $caeMark, $k, $course_type_id)", 'class'=>'caenew_'.$cm_id, 'asessment_type'=>'cae'));
							$k++;
						}
						echo "</td>";
						echo "<td>".$min_cae_pass_mark."</td>";
						...
						echo $this->Form->input('ese_id', array('type'=> 'hidden', 'style'=>'width:50px;border-color:#000;color:#000;padding-left:10px;', 'label'=>false, 'default'=>$ese_id, 'name' => 'data[ese_id]['.$cm_id.']'));
						echo $this->Form->input('ese_old_'.$cm_id, array('type'=> 'hidden', 'style'=>'width:50px;border-color:#000;color:#000;padding-left:10px;', 'label'=>false, 'default'=>$ese, 'name' => 'data[ese_old]['.$cm_id.']'));
						echo $this->Form->input('ese_'.$cm_id, array('type'=> 'text', 'style'=>'width:50px;border-color:#000;color:#000;padding-left:10px;', 'label'=>false, 'default'=>$ese, 'name' => 'data[ese]['.$cm_id.']', 'onkeyup'=>"computeIndividual('$cm_id', 'ese', this.value, $max_cae_mark)"));
						echo "</td>";
			...
			case 5:
				echo "<tr id=cm_id_$cm_id class='cm_id'>";
					echo "<td>".$j."</td>";
					echo "<td>".$course_code."</td>";
					echo "<td>Professional Training</td>";
					echo "<td>".$course_max_marks."</td>";
					echo "<td></td>";
					...
					echo "<td>";
						echo $this->Form->input('course_type_id', array('type'=> 'hidden', 'style'=>'width:50px;', 'label'=>false, 'default'=>$course_type_id, 'name' => 'data[course_type_id]'));
						$cae_id = $csmArray['CourseMapping']['CaePt']['ProfessionalTraining'][0]['id'];
						$cae = $csmArray['CourseMapping']['CaePt']['ProfessionalTraining'][0]['marks'];
						echo $this->Form->input('course_type_id_'.$cm_id, array('type'=> 'hidden', 'style'=>'width:50px;', 'label'=>false, 'default'=>$course_type_id, 'name' => 'data[Practical][course_type_id]'));
						echo $this->Form->input('cae_id', array('type'=> 'hidden', 'style'=>'width:50px;border-color:#000;color:#000;padding-left:10px;', 'label'=>false, 'default'=>$cae_id, 'name' => 'data[cae_id]['.$cm_id.']'));
						echo $this->Form->input('cae_old_'.$cm_id, array('type'=> 'hidden', 'style'=>'width:50px;border-color:#000;color:#000;padding-left:10px;', 'label'=>false, 'default'=>$cae, 'name' => 'data[cae_old]['.$cm_id.']'));
						echo $this->Form->input('cae_'.$cm_id, array('type'=> 'text', 'style'=>'width:50px;border-color:#000;color:#000;padding-left:10px;', 'label'=>false, 'default'=>$cae, 'name' => 'data[cae]['.$cm_id.']', 'onkeyup'=>"computeIndividual('$cm_id', 'cae', this.value, $max_cae_mark, 0)"));
