	...
	<tbody>
		...
		?>
					<tr class=" gradeX">
						...
						<td>
						<?php
						if($this->Html->checkPathAccesstopath('TheoryArrears/editMarks','',$authUser['id'])){ 
							echo $this->Html->link("<i class='fa fa-pencil fa-lg'></i>",array("controller"=>"TheoryArrears",'action' => 'editMarks', $cm_id, $exam_month_year_id, $model), array('escape' => false,'style'=>'padding-left:10px;'));
						} 
						?>
						</td>
					</tr>
