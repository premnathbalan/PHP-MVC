...
<table cellpadding="0" cellspacing="0" border="0" class="display" id="example" style="margin-top:10px;">
	...
	<tr class=" gradeX">
		...
		<td>
			<?php
				echo $this->Form->input('cae_old_marks', array('type'=> 'hidden','id'=>'CaeOldMark'.$i, 'default'=>$cae_mark, 'class'=>'dummy','style'=>'position:relative;margin-top:-14px;width:50px;border-color:#000;color:#000;padding-left:10px;', 'label'=>false, 'name' => 'data[InternalExam][cae_old_marks]['.$student_id.']'));
