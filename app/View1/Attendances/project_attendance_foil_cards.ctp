<div>
	...
	<div class="col-sm-9">	
		...
		<div class="col-lg-3">		
			<?php echo $this->Form->input('CAE',array('type' => 'select','options'=>array('CAE1'=>'CAE 1','CAE2'=>'CAE 2','CAE3'=>'CAE 3','ESE'=>'ESE'), 'style'=>'width:70px;margin-top:5px;')); ?>
		</div>
		<div class="col-lg-3">
			<?php echo $this->Form->button('<i class="ace-icon fa fa-check bigger-110"></i>'.__('Submit'),array('type'=>'button','name'=>'submit','value'=>'submit','class'=>'btn',"onclick"=>"attendanceSearch('','P','P-F','4');"));?>
		</div>		
...
<?php echo $this->Html->link("<span class='navbar-brand'><small>ATTENDANCE <i class='ace-icon fa fa-angle-double-right'></i></small></span>", array("controller"=>"Attendances",'action' => 'project_attendance_foil_cards'),array('data-placement'=>'left','escape' => false)); ?>
</span>
